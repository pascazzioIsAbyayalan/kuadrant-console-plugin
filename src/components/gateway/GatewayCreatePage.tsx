...
const GatewayCreatePage: React.FC<GatewayCreatePageProps> = ({ onFormChange, isEmbedded }) => {
  ...
  const [isLoading, setIsLoading] = React.useState(() => Boolean(nameEdit && nameEdit !== '~new'));
  ...
  return (
    <>
                                    ...
                                    <Td dataLabel={t('Type')}>
                                      ...
                                      >
                                        <FormSelectOption
                                          ...
                                          label={t('IPAddress')}
                                        />
                                        <FormSelectOption value="Hostname" label={t('Hostname')} />
                                      </FormSelect>
                                    </Td>
      ...
      <Modal variant="large" isOpen={isModalOpen} onEscapePress={handleModalClose}>
        <Wizard
          header={
            <WizardHeader
